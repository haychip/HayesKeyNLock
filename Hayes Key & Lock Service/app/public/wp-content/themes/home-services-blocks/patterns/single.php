...
/**
 * Title: Single Post
 * Slug: home-services-blocks/single-post
 * Categories: home-services-blocks, single-post
 */
?>
...
<div class="wp-block-group"><!-- wp:post-navigation-link {"type":"previous","showTitle":true,"style":{"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}},"textColor":"primary","fontSize":"medium"} /-->

<!-- wp:post-navigation-link {"showTitle":true,"style":{"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}},"textColor":"primary","fontSize":"medium"} /--></div>
<!-- /wp:group -->

<!-- wp:comments -->
<div class="wp-block-comments"><!-- wp:comments-title {"textAlign":"center","level":4} /-->
...
<!-- wp:post-comments-form {"textAlign":"left"} /--></div>
<!-- /wp:comments --></div>
<!-- /wp:column -->
